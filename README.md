...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-geofacet-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10749&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-geofacet-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-geofacet` can be installed with:

```
conda install r-geofacet
```

It is possible to list all of the versions of `r-geofacet` available on your platform with:
